...
class Network(object):
    ...
    def __init__(self, network_params=None, analysis_params=None, new_network_params={},
        ...
        if derive_params:
            ...
            derived_network_params = self._calculate_dependent_network_parameters(new_network_params)
    ...
    def _calculate_dependent_network_parameters(self, new_network_params=None):
        """
